...
export const WeightEntryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WeightEntryFindFirstOrThrowArgs> = z.object({
...
export default WeightEntryFindFirstOrThrowArgsSchema;
