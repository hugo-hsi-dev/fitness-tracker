...
export const WeightEntryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WeightEntryFindUniqueOrThrowArgs> = z.object({
  select: WeightEntrySelectSchema.optional(),
  include: WeightEntryIncludeSchema.optional(),
  where: WeightEntryWhereUniqueInputSchema,
}).strict() ;

export default WeightEntryFindUniqueOrThrowArgsSchema;
